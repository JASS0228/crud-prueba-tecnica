<script setup lang="ts">
	...
	const handleSubmit = async () => {
		...
		alert.message = 'Hotel modificado correctamente esperando redirection...'
		alert.type = false
...
<template>
	<div class="flex flex-col items-center justify-center">
		...
		<form
			...
			<input
				type="submit"
				class="bg-green-500 mt-3 w-full p-2 rounded-lg text-white font-bold hover:bg-green-600 cursor-pointer transition-all"
